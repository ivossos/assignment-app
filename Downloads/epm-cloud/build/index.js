        ...
        try {
            ...
            switch (name) {
                ...
                case 'run_consolidation':
                    result = await fccsClient.runJob(args.application, 'Rules', 'Consolidate', {
                ...
                case 'run_business_rule':
                    ...
                    if (args.parameters) {
                        try {
                            ruleParams = JSON.parse(args.parameters);
                        }
                        catch (e) { }
                    }
                ...
                case 'generate_report':
                    ...
                    if (args.parameters) {
                        try {
                            reportParams = JSON.parse(args.parameters);
                        }
                        catch (e) { }
                    }
                ...
                case 'simulate_transaction':
                    result = await fccsClient.simulateTransaction(args.application, args.type, args.entity, args.percentage, args.amount);
                    break;
                default:
    ...
    try {
        ...
        switch (toolName) {
            ...
            case 'run_business_rule':
                ...
                if (args.parameters) {
                    try {
                        ruleParams = typeof args.parameters === 'string' ? JSON.parse(args.parameters) : args.parameters;
                    }
                    catch (e) { }
                }
                result = await fccsClient.runJob(args.application, 'Rules', args.ruleName, ruleParams);
            ...
            case 'generate_report':
                ...
                if (args.parameters) {
                    try {
                        reportParams = typeof args.parameters === 'string' ? JSON.parse(args.parameters) : args.parameters;
                    }
                    catch (e) { }
                }
                result = await fccsClient.generateReport(args.application, args.reportName, reportParams);
